...
public class Main extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		//pekar på att notefxmenu.fxml ska användas som fxml fil
		Parent root = FXMLLoader.load(getClass().getResource("notefxmenu.fxml"));

		Scene scene = new Scene(root);
		// Sätter ikon för programmet.
		...
		//Sätter custom ruta då man klickar krysset.
	...
	/**
	 * Metod för dialogruta då man kryssar.
	 * Stänger vid exit men ej vid cancel.
	 */
	public void close() {
