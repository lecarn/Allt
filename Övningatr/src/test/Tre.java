...
public class Tre {
	...
	public static void main(String[] args) {
		...
		System.out.println("Hur många liter vatten ska kokas?");
		while(!input.hasNextDouble()) {
			input.next();
			System.out.println("Ange endast hur många liter i siffror");
		}
		double litre = input.nextDouble();
		// antal liter anges(while för att se till att endast siffror kommer in)
		...
		System.out.println("Det användes "+(df.format(energy))+" joules");// ger svar.
