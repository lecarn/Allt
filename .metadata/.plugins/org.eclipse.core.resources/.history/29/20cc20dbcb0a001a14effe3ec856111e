...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Lägger till 2 hundar och 2 matte(aka husse enligt uppgift)
		...
		System.out.println("Matte för Loki är " + loki.getMatte().getName());
		...
		for (int i = 0; i < monica.getHundList().size(); i++) {
			System.out.println(monica.getName() + " har hunden " + monica.getHundList().get(i).getName()
					+ " som är av rasen " + monica.getHundList().get(i).getBreed());
		}
